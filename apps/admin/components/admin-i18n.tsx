...
const copy = {
  ...
  "reports.title": ["Laporan operasional", "Operational reports"],
  "reports.description": ["Baca performa booking berdasarkan tanggal booking dan unduh laporan siap pakai.", "Review booking performance by booking date and download a ready-to-use report."],
