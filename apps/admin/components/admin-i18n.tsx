...
const copy = {
  ...
  "dashboard.description": ["Kondisi operasional Shakila Group langsung dari PostgreSQL.", "Shakila Group operations, live from PostgreSQL."],
  ...
  "catalog.snapshot": ["Snapshot booking historis tetap tidak berubah.", "Historical booking snapshots remain unchanged."],
  "settings.title": ["Pengaturan bisnis", "Business settings"],
  "settings.description": ["DP dan durasi hold yang menjadi aturan server.", "Server-authoritative DP and hold duration."],
  ...
  "login.demoCredentials": ["Kredensial demo", "Demo credentials"],
