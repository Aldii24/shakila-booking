...
const conditions = ["Harga berlaku untuk 1 booking paket dan kapasitas maksimal sesuai tipe kamar", "Paket mencakup 1 malam dan 1 kali tour Jeep; malam tambahan mengikuti tarif kamar", "Harga dapat disesuaikan jika tarif resmi destinasi berubah", "Tambahan akhir pekan atau hari libur Rp50.000 per paket", "Ketersediaan kamar mengikuti seluruh rentang menginap dan Jeep mengikuti tanggal tour"] as const;
const families = [
